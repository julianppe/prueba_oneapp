...
dash.register_page(__name__,
                   path='/violence-domestic',  # represents the url text
                   name='Percentage of women who have experienced some type of violence by a partner',  # name of page, commonly used as name of link
                   title='Percentage of women who have experienced some type of violence by a partner'  # epresents the title of browser's tab
)
