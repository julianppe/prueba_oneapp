...
dash.register_page(__name__,
                   ...
                   name='Porcentaje de mujeres que piensan que está justificado que los maridos golpeen a sus esposas en algunas situaciones',  # name of page, commonly used as name of link
                   title='Porcentaje de mujeres que piensan que está justificado que los maridos golpeen a sus esposas en algunas situaciones'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/gender_roles_spanish/justifica_golpear.csv")
...
layout = html.Div([
        dbc.Row([
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in df.pais.unique()], multi=True, value="Argentina", id='page17_gender_roles_spanish-pais_elect')
        ], width=6),
        dbc.Col([
        ...
        dbc.Row([
        dbc.Col([
        dcc.RangeSlider(id='page17_gender_roles_spanish-the_year',
                min=2000,
                max=2021,
                value=[2000,2021],
                marks=mark_values,
...
@callback(
    ...
    Input('page17_gender_roles_spanish-pais_elect', 'value'),
    Input('page17_gender_roles_spanish-comparacion_por_elect', 'value'),
    [Input('page17_gender_roles_spanish-the_year','value')]
)
