...
dash.register_page(__name__,
                   path='/tasa-fecundidad-total',  # represents the url text
...
# page 1 data
df = pd.read_csv("datasets/familia_spanish/tasa_fecundidad_total.csv")
...
layout = html.Div([
        ...
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in list_comparacion_por_ordenada], multi=False, persistence=True, persistence_type='memory', value='Mujeres', id='page28_familia_spanish-comparacion_por_elect')
        ], width=6),
    ]),
        dbc.Row([
        dbc.Col([
