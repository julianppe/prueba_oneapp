...
layout = html.Div([
        dbc.Row([
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in df.pais.unique()], multi=True, id='page4_familia_spanish-pais_elect')
        ], width=6),
        dbc.Col([
...
@callback(
    Output('page4_familia_spanish-pais_elect', "value"),
    Output("store", "data"),
