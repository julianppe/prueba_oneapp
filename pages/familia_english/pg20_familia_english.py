...
# page 1 data
df = pd.read_csv("datasets/familia_english/fecundidad.csv")
...
layout = html.Div([
        dbc.Row([
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in df.pais.unique()], multi=True, value="Argentina",  id='page20_familia_english-pais_elect')
        ], width=6),
        dbc.Col([
