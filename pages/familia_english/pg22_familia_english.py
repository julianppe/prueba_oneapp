...
layout = html.Div([
        ...
        dbc.Row([
        dbc.Col([
            dcc.Graph(id='page22_familia_english-line', config={'displayModeBar':False})
        ], width=12),
    ]),
        dbc.Row([
        dbc.Col([
        dcc.RangeSlider(id='page22_familia_english-the_year',
                min=2000,
                max=2021,
                value=[2000,2021],
                marks=mark_values,
...
@callback(
    Output('page22_familia_english-line', 'figure'),
    Input('page22_familia_english-pais_elect', 'value'),
    Input('page22_familia_english-comparacion_por_elect', 'value'),
    [Input('page22_familia_english-the_year','value')]
)
