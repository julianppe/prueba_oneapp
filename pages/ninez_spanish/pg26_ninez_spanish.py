...
dash.register_page(__name__,
                   path='/sigue-normas-6to',  # represents the url text
                   name="Alumnos de sexto grado que responde que si a 'Sigo las normas y reglas de la clase'",  # name of page, commonly used as name of link
                   title="Alumnos de sexto grado que responde que si a 'Sigo las normas y reglas de la clase'"  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/ninez_spanish/sigue_normas_6to.csv")
...
layout = html.Div([
        ...
        dbc.Row([
        dbc.Col([
            dcc.Graph(id='page26_ninez_spanish-line', config={'displayModeBar':False})
        ], width=12),
    ]),
        dbc.Row([
        dbc.Col([
...
@callback(
    Output('page26_ninez_spanish-line', 'figure'),
    Input('all-pages-dropdown-pais-ninez-spanish', 'value'),
    Input('page26_ninez_spanish-comparacion_por_elect', 'value'),
