...
layout = html.Div([
        dbc.Row([
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in df.pais.unique()], multi=True, value="Argentina", id='page14_ninez_spanish-pais_elect')
        ], width=6),
        dbc.Col([
        ...
        dbc.Row([
        dbc.Col([
        dcc.RangeSlider(id='page14_ninez_spanish-the_year',
                min=2000,
                max=2021,
                value=[2000,2021],
                marks=mark_values,
...
@callback(
    ...
    Input('page14_ninez_spanish-pais_elect', 'value'),
    Input('page14_ninez_spanish-comparacion_por_elect', 'value'),
    [Input('page14_ninez_spanish-the_year','value')]
)
