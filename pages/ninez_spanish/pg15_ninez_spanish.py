...
from elements.elements_ninez_spanish import ranger_slider_year_ninez_spanish, generate_dropdown
...
layout = html.Div([
        ...
        dbc.Row([
        dbc.Col([
            ranger_slider_year_ninez_spanish,
        ], width=12),
    ]),
])
...
@callback(
    ...
    Input('all-pages-dropdown-pais-ninez-spanish', 'value'),
    Input('page15_ninez_spanish-comparacion_por_elect', 'value'),
    [Input('all-pages-ranger-slider-year-ninez-spanish','value')]
)
