...
layout = html.Div([
        ...
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in list_comparacion_por_ordenada], multi=False, persistence=True, persistence_type='memory', value='Total', id='page17_empleo_spanish-comparacion_por_elect')
        ], width=6),
    ]),
        dbc.Row([
        dbc.Col([
            dcc.Graph(id='page17_empleo_spanish-line', config={'displayModeBar':False})
        ], width=12),
    ]),
        dbc.Row([
        dbc.Col([
...
# @callback(
#     Output('page17_empleo_spanish-pais_elect', "value"),
#     Output("store_empleo_spanish", "data"),
#     Input('page17_empleo_spanish-pais_elect', "value"),
#     State("store_empleo_spanish", "data"),
# )


@callback(
    Output('page17_empleo_spanish-line', 'figure'),
    Input('all-pages-dropdown-pais-empleo-spanish', 'value'),
    Input('page17_empleo_spanish-comparacion_por_elect', 'value'),
