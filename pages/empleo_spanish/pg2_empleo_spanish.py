...
# page 1 data
df = pd.read_csv("E:/Dropbox/multipage/projectGENLAC/dash_final_oneapp/datasets/empleo_spanish/empleo.csv")
...
layout = html.Div([
        ...
        dbc.Row([
        dbc.Col([
            dcc.Graph(id='page2_empleo_spanish-line', config={'displayModeBar':False})
        ], width=12),
    ]),
        dbc.Row([
        dbc.Col([
        dcc.RangeSlider(id='page2_empleo_spanish-the_year',
                min=2000,
                max=2021,
                value=[2000,2021],
                marks=mark_values,
...
#@callback(
#    Output('page2_empleo_spanish-pais_elect', "value"),
