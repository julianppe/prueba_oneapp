...
dash.register_page(
    __name__,
    path='/ingreso_laboral',  
    name='Efecto maternidad sobre ingreso laboral',  
    title='Efecto maternidad sobre ingreso laboral'
)
...
df = pd.read_csv("datasets/empleo_spanish/ingreso_laboral_mat.csv")
...
layout = html.Div([
    dbc.Row([
        ...
        dbc.Col([
            dcc.Dropdown(
                ...
                id='page_maternidad_ingreso_laboral-comparacion_por'
            )
        ], width=6),
    ]),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Graph(
                id='page_maternidad_ingreso_laboral-line',
...
@callback(
    Output('page_maternidad_ingreso_laboral-line', 'figure'),
    Input('all-pages-dropdown-pais-empleo-spanish', 'value'),
    Input('page_maternidad_ingreso_laboral-comparacion_por', 'value')
)
def update_graph(pais_v, comparacion_por_v):
    ...
    + "Cada punto representa el cambio porcentual en el ingreso laboral mensual en el "
