...
dash.register_page(
    __name__,
    path='/informalidad',  
    name='Efecto maternidad sobre informalidad',  
    title='Efecto maternidad sobre informalidad'
)
...
df = pd.read_csv("datasets/empleo_spanish/informalidad_mat.csv")
...
layout = html.Div([
    dbc.Row([
        ...
        dbc.Col([
            dcc.Dropdown(
                ...
                id='page_maternidad_informalidad-comparacion_por'
            )
        ], width=6),
    ]),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Graph(
                id='page_maternidad_informalidad-line',
...
@callback(
    Output('page_maternidad_informalidad-line', 'figure'),
    Input('all-pages-dropdown-pais-empleo-spanish', 'value'),
    Input('page_maternidad_informalidad-comparacion_por', 'value')
)
def update_graph(pais_v, comparacion_por_v):
    ...
    + "Cada punto representa el cambio porcentual en la tasa de informalidad laboral en el "
