...
# page 1 data
df = pd.read_csv("datasets/empleo_spanish/desempleo.csv")
...
layout = html.Div([
        dbc.Row([
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in df.pais.unique()], multi=True, value="Argentina", id='page3_empleo_spanish-pais_elect')
        ], width=6),
        dbc.Col([
