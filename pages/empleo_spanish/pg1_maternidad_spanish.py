...
dash.register_page(
    __name__,
    path='/participacion',  
    name='Efecto maternidad sobre participación laboral',  
    title='Efecto maternidad sobre participación laboral'
)
...
df = pd.read_csv("datasets/empleo_spanish/participacion_mat.csv")
...
layout = html.Div([
    dbc.Row([
        ...
        dbc.Col([
            dcc.Dropdown(
                ...
                id='page_maternidad_participacion-comparacion_por'
            )
        ], width=6),
    ]),
    ...
    dbc.Row([
        dbc.Col([
            dcc.Graph(
                id='page_maternidad_participacion-line',
...
@callback(
    Output('page_maternidad_participacion-line', 'figure'),
    Input('all-pages-dropdown-pais-empleo-spanish', 'value'),
    Input('page_maternidad_participacion-comparacion_por', 'value')
)
def update_graph(pais_v, comparacion_por_v):
    ...
    + "Cada punto representa el cambio porcentual en la tasa de participación laboral en el "
