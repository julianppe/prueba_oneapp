...
# page 1 data
df = pd.read_csv("datasets/empleo_english/cuentapropistas.csv")
...
layout = html.Div([
        dbc.Row([
        dbc.Col([
            dcc.Dropdown(options=[{'label': x, 'value': x} for x in df.pais.unique()], multi=True, value="Argentina", id='page8_empleo_english-pais_elect')
        ], width=6),
        dbc.Col([
