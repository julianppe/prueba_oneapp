...
dropdown_empleo_english = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem(divider=True),
            dbc.DropdownMenuItem("Motherhood effects", header=True),
            dbc.DropdownMenuItem("Labor force participation", href="/empleo_english/participation"),
            dbc.DropdownMenuItem("Employment", href="/empleo_english/employment"),
            dbc.DropdownMenuItem("Hours worked", href="/empleo_english/hours_worked"),
            dbc.DropdownMenuItem("Labor income", href="/empleo_english/labor_income"),
            dbc.DropdownMenuItem("Labor informality", href="/empleo_english/informality"),
        ],
        size="lg",
        nav=True,
        in_navbar=True,
