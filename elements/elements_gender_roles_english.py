...
dropdown_gender_roles_english = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem("Third-grade teachers who think that boys or girls learn faster math or language", href="/gender_roles_english/learn-faster-3rd"),
            ...
            dbc.DropdownMenuItem("Sixth-grade teachers who think that boys or girls learn faster math, language or science", href="/gender_roles_english/learn-faster-6th"),
            dbc.DropdownMenuItem("Sixth-grade teachers who think that boys or girls learn faster math, language or science due to their innate characteristics", href="/gender_roles_english//learn-faster-6th-innate"),
