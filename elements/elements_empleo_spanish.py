...
dropdown_empleo_spanish = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem(divider=True),
            dbc.DropdownMenuItem("Efectos maternidad", header=True),
            dbc.DropdownMenuItem("Participación laboral", href="/empleo_spanish/participacion"),
            dbc.DropdownMenuItem("Empleo", href="/empleo_spanish/empleo"),
            dbc.DropdownMenuItem("Horas trabajadas", href="/empleo_spanish/horas_trabajadas"),
            dbc.DropdownMenuItem("Ingreso laboral", href="/empleo_spanish/ingreso_laboral"),
            dbc.DropdownMenuItem("Informalidad laboral", href="/empleo_spanish/informalidad"),
        ],
        size="lg",
        nav=True,
        in_navbar=True,
