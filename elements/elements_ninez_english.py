...
dropdown_ninez_english = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem("Ratio of standardized tests scores for 3rd grade students", href="/ninez_english/ratio-3rd"),
            dbc.DropdownMenuItem("Ratio of standardized tests scores for 6th grade students", href="/ninez_english/ratio-6th"),
            dbc.DropdownMenuItem("Ratio of standardized tests scores for 15 year-old students", href="/ninez_english/ratio-15"),
