...
dropdown_ninez_english = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem("Sixth grades students responding yes to 'I follow class rules and regulations.'", href="/ninez_english/follow-rules-6th"),
            dbc.DropdownMenuItem("Sixth grades students responding yes to 'I ask the teacher for help when I don't understand what to do.'", href="/ninez_english/ask-for-help-6th"),
            dbc.DropdownMenuItem("Sixth grades students responding yes to 'Before turning in an assignment or test I check it well.'", href="/ninez_english/double-check-6th"),
            dbc.DropdownMenuItem("Sixth grades students responding yes to 'I wait my turn to speak in class.'", href="/ninez_english/wait-to-speak-6th"),
            dbc.DropdownMenuItem("Sixth grades students responding yes to 'Even if things don't work out for me, I keep trying'.", href="/ninez_english/keep-trying-6th"),
