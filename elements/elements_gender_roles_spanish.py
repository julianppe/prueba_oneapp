...
dropdown_gender_roles_spanish = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem("Docentes de 3er grado que opinan que niños o niñas aprenden más rápido matemática o lengua debido a características innatas", href="/gender_roles_spanish/aprenden-rapido-3ro-innato"),
            ...
            dbc.DropdownMenuItem("Docentes de 6to grado que opinan que niños o niñas aprenden más rápido matemática, lengua o ciencias debido a características innatas", href="/gender_roles_spanish/aprenden-rapido-6to-innato"),
