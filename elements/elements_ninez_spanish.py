...
dropdown_ninez_spanish = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem("Porcentaje de jóvenes de 15 a 24 fuera de la escuela y del mercado laboral", href="/ninez_spanish/jovenes-fuera-escuela-trabajo-ninez"),
            dbc.DropdownMenuItem(divider=True),
