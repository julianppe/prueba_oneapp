...
dropdown_ninez_spanish = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem("Participación en actividades de cuidado", href="/ninez_spanish/participacion-actividades-cuidado"),
            dbc.DropdownMenuItem("Horas semanales dedicadas a actividades de cuidado", href="/ninez_spanish/horas-actividades-cuidado"),
            dbc.DropdownMenuItem("Participación en actividades de cuidado de niños", href="/ninez_spanish/participacion-actividades-cuidado-ninos"),
            dbc.DropdownMenuItem("Horas semanales dedicadas a actividades de cuidado de niños", href="/ninez_spanish/horas-actividades-cuidado-ninos"),
