...
dropdown_ninez_spanish = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem("Alumnos de sexto grado que responden que sí a 'Sigo las normas y reglas de la clase.'", href="/ninez_spanish/sigue-normas-6to"),
            dbc.DropdownMenuItem("Alumnos de sexto grado que responden que sí a 'Pido ayuda al profesor cuando no entiendo lo que hay que hacer.'", href="/ninez_spanish/pide-ayuda-6to"),
            dbc.DropdownMenuItem("Alumnos de sexto grado que responden que sí a 'Antes de entregar una tarea o examen lo reviso bien.'", href="/ninez_spanish/revisa-bien-6to"),
            dbc.DropdownMenuItem("Alumnos de sexto grado que responden que sí a 'Espero mi turno para hablar en clases.'", href="/ninez_spanish/espera-para-hablar-6to"),
            dbc.DropdownMenuItem("Alumnos de sexto grado que responden que sí a 'Aunque las cosas no me resulten, sigo intentándolo'", href="/ninez_spanish/sigue-intentando-6to"),
