...
dropdown_familia_spanish = dbc.Row([
    dbc.Col(
        ...
        children=[
            ...
            dbc.DropdownMenuItem("Participación en tareas domésticas", href="/familia_spanish/tareas-domesticas"),
            dbc.DropdownMenuItem("Horas semanales en tareas domésticas", href="/familia_spanish/horas-tareas-domesticas"),
            dbc.DropdownMenuItem("Participación en actividades de cuidado", href="/familia_spanish/actividades-cuidado"),
            dbc.DropdownMenuItem("Horas semanales dedicadas a actividades de cuidado", href="/familia_spanish/horas-actividades-cuidado"),
            dbc.DropdownMenuItem("Participación en actividades de cuidado de niños", href="/familia_spanish/actividades-cuidado-ninos"),
            dbc.DropdownMenuItem("Horas semanales dedicadas a actividades de cuidado de niños", href="/familia_spanish/horas-actividades-cuidado-ninos"),
            dbc.DropdownMenuItem("Participación en actividades de apoyo a otros hogares", href="/familia_spanish/actividades-apoyo"),
            dbc.DropdownMenuItem("Horas semanales dedicadas a actividades de apoyo a otros hogares", href="/familia_spanish/horas-actividades-apoyo"),
            dbc.DropdownMenuItem("Participación en actividades de ocio", href="/familia_spanish/actividades-ocio"),
            dbc.DropdownMenuItem("Horas semanales dedicadas a actividades de ocio", href="/familia_spanish/horas-actividades-ocio"),
            dbc.DropdownMenuItem(divider=True),
